...
description: Universal AI Skill for Technical SEO, Generative Engine Optimization (GEO), Core Web Vitals, Schema markup, and visibility across Google, Bing, ChatGPT, Claude, and Perplexity.
---
